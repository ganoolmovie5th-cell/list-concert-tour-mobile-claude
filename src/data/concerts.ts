...
export const CONCERTS: Concert[] = [
...

  {
    ...
    ticketPlatform: 'TipTip',
    ticketUrl: 'https://tiptip.id/event/1ed94c3e-e5ce-4ff7-a960-95deab84640f',
    priceRange: 'Rp 1.050.000 — TBA',
    priceMin: 1050000, priceMax: 0,
    ticketCategories: [
      { name: 'Nightrain Fan Club Presale (2 Jul)', price: 'Mulai Rp 1.050.000' },
      { name: 'BALE by BTN Presale (16 Jul)', price: 'Coming Soon' },
      { name: 'General Sale (30 Jul)', price: 'Coming Soon' },
    ],
    confirmStatus: 'confirmed', hot: true,
    description: "Guns N' Roses kembali ke Jakarta dalam rangkaian World Tour 2026. Axl Rose, Slash, dan Duff McKagan tampil di Stadion Madya GBK membawakan hits legendaris seperti Welcome to the Jungle, Sweet Child O' Mine, dan November Rain. Tiket presale via TipTip.",
    sources: ['gnrjakarta.com', 'tiptip.id'],
  },
